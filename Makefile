...
OFILES = main.o myLib.o text.o game.o font.o beast.o start.o tink.o flower.o gameOver.o winGame.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h text.h game.h beast.h start.h tink.h flower.h gameOver.h winGame.h
